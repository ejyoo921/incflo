...
namespace 
{
    ...
    { // artificial viscosity for simultation
        ...
        { 
            visc_1a = 100.0;
            // visc_1a = 0.01; // EY: test for two Vel. case Dec. 23
        }
        return visc_1a;
    }
    ...
    { // calculate rho based on phase and temp
        ...
        switch (phase) {
            ...
            kcalc = 36.5;
            // kcalc = 3.65;
            // 30 - 40: EY: test for two vel case temp. Dec. 23
            // linear gradient between T1 and T2 -> Jump later
            // if (Temp >= T2)
            // { 
            //     kcalc = 40.0;
            // }
            ...
            // { 
            //     slope = (40-30)/(T2-T1);
            //     kcalc = 30.0 + Temp*slope;
            // } // Do the same thing with viscosity
