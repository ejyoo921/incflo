#include <incflo.H>
#include <DiffusionTensorOp2.H>
#include <AMReX_ParmParse.H>

using namespace amrex;

DiffusionTensorOp2::DiffusionTensorOp2 (incflo* a_incflo)
    : m_incflo(a_incflo)
{
    readParameters();
...
void
DiffusionTensorOp2::readParameters ()
{
...
void
DiffusionTensorOp2::diffuse_velocity (Vector<MultiFab*> const& velocity,
...
void DiffusionTensorOp2::compute_divtau (Vector<MultiFab*> const& a_divtau,
                                        Vector<MultiFab const*> const& a_velocity,
                                        Vector<MultiFab const*> const& a_density,
                                        Vector<MultiFab const*> const& a_eta)
{
    BL_PROFILE("DiffusionTensorOp2::compute_divtau");
